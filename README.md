...
| 🎡 Eva Akademi | `akademi/` | Etkinlik kitabından 6 mini oyun: ♻️ geri dönüşüm (sürükle-bırak), 🇬🇧 İngilizce dinle-bul (en-US sesli: zıt anlamlılar/aile/yiyecekler), 🥦 sağlıklı-sağlıksız ayırma, 🌑 gölge bulmaca (emoji silüeti), 🔍 kaç tane? (görsel dikkat + sayma), 🧠 görsel hafıza (3×3 tablo ezberle-yanıtla) |
